...
AUTO_ACCOUNT_SKR04 = {
    "chart_skr04_1181": {
        "datev_automatic_tax": ["tax_vst_7_skr04"],
        "datev_automatic_account": True,
        "datev_vatid_required": False,
    },
    "chart_skr04_1186": {
        "datev_automatic_tax": ["tax_vst_19_skr04"],
        "datev_automatic_account": True,
        "datev_vatid_required": False,
    },
    "chart_skr04_3260": {
        "datev_automatic_tax": ["tax_ust_7_skr04"],
        "datev_automatic_account": True,
        "datev_vatid_required": False,
    },
    "chart_skr04_3272": {
        "datev_automatic_tax": ["tax_ust_19_skr04"],
        "datev_automatic_account": True,
        "datev_vatid_required": False,
    },
    "chart_skr04_4125": {
...
class AccountAccount(models.Model):
    ...
    def _set_account_autoaccount_skr04(self, company_id):
        for key, values in AUTO_ACCOUNT_SKR04.items():
            ...
            account_id = self.env.ref(account_name, raise_if_not_found=False)
            if not account_id:
                _logger.warning("Account %s not found for company %s", key, company_id)
                continue
