...
class SyscoonFinanceinterface(models.Model):
    ...
    journals = fields.Char(readonly=True)
    ...
    def generate_export_lines(self, move):
        ...
        for line in move.line_ids:
            ...
            if line.account_id.id == move.export_account_counterpart.id:
                amount_real += self.compute_amount_real(line)
                continue
    ...
    def compute_amount_real(self, line):
        """computes the real amount of the move line with taxes if if tax_ids are given"""
